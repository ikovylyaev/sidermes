...
<div class="col-10" style="margin: 10px auto;" data-spy="scroll" data-target="#catalog" data-offset="0">
	...
	<table class="table table-hover">
		...
		<tbody>
			<tr>
				...
				<td><a href="#"><img src="http://sidermes.com/img/a2_150.jpg"></a></td>
			...
			<tr>
				...
				<td><a href="#"><img src="http://sidermes.com/img/A%203_150.jpg"></a></td>
			...
			<tr>
				...
				<td><a href="#"><img src="http://sidermes.com/img/sub_prev.jpg"></a></td>
			...
			<tr>
				...
				<td><a href="#"><img src="http://sidermes.com/img/A%204_150.jpg"></a></td>
			...
			<tr>
				...
				<td><a href="#"><img src="http://sidermes.com/img/F%201_150.jpg"></a></td>
			...
			<tr class="sectiontableentry1">
				<td><a href="#">TOX</a></td>
				<td><a href="#"><img src="http://sidermes.com/img/a%205_150.jpg"></a></td>
	...
	<table class="table table-hover">
		...
		<tbody>
			...
			<tr>
				<td><a href="#">TOX</a></td>
				<td><a href="#"><img src="http://sidermes.com/img/NF%204_150.jpg"></a></td>
				<td>Наши зонды ТОX, зонды для измерения температуры+ppm Кислорода, в течении 4-6 секунд измеряют свободный кислород содержащийся в расплавленном металле.
				Данные зонды создают два сигнала: замер температуры от термопары, и потенциометрический сигнал в мВ от ячейки для кислорода. Цифровой инструмент измерения использует эти значения и показывает их на дисплее, вместе со значением ppm (рассчитанного с применением формулы на основании параметров Т и мВ).
				Кроме того, в зависимости от значения присутствующих ppm, автоматически рассчитывается значение %C или %Al в расплавленном металле (рассчитанного с применением формулы на основании Т и ppm кислорода).</td>
				<td><a href="#">Подробнее</a></td>
	...
	<table class="table table-hover">
		...
		<tbody>
			<tr class="sectiontableentry1">
				...
				<td><a href="#"><img src="http://sidermes.ru/images/stories/alu3.jpg"></a></td>
			...
			<tr class="sectiontableentry1">
				...
				<td><a href="#"><img src="http://sidermes.com/img/siderlab_II_t_p_1.jpg"></a></td>
			...
			<tr class="sectiontableentry1">
				...
				<td><a href="#"><img src="http://sidermes.com/img/siderport_II_S_1.jpg"></a></td>
			...
			<tr class="sectiontableentry1">
				...
				<td><a href="#"><img src="http://sidermes.com/img/sidertemp_II_1.jpg"></a></td>
			...
			<tr class="sectiontableentry1">
				...
				<td><a href="#"><img src="http://sidermes.com/img/sidertop_1.jpg"></a></td>
			...
			<tr class="sectiontableentry2">
				...
				<td><a href="#"><img src="http://2.wfire.z8.ru/components/com_virtuemart/show_image_in_imgtag.php?filename=resized%2FSUPERTEMP_OPTICA_4b970b02d5974_90x90.png&amp;newxsize=90&amp;newysize=90&amp;fileout=" alt="" border="0"></a></td>
